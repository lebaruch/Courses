...
try:
    Draw(pred, finance_features, poi, mark_poi=False, name="2featclusters.pdf", f1_name=feature_1, f2_name=feature_2)
except NameError:
...
print "#######################\nMaximum and minimum exercised_stock_options"
...
#outro jeito de achar o minimo e maximo esse jeito Eh mais facil!!!!!!!!!!!!
salary_other = []

for i in data_dict:
    val = data_dict[i]['salary']
    if val != "NaN":
        salary_other.append(val)

print max(salary_other)
print min(salary_other)
