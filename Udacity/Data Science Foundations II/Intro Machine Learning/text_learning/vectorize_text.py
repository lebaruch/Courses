...
os.chdir('D:/DataScience/Courses/Udacity/Data Science Foundations II/Intro Machine Learning/text_learning')
sys.path.append( "D:/DataScience/Courses/Udacity/Data Science Foundations II/Intro Machine Learning/enron_mail_20110402/" )
...
for name, from_person in [("sara", from_sara), ("chris", from_chris)]:
    ...
    #    temp_counter += 1
    #    if temp_counter < 200:
            path = "D:/DataScience/Courses/Udacity/Data Science Foundations II/Intro Machine Learning/enron_mail_20110402/"+path[:-1]
            email = open(path, "r")
